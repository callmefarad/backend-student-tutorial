...
var FirestoreClient = /** @class */ (function () {
     ...
     */
    FirestoreClient.prototype.start = function (databaseInfo, offlineComponentProvider, onlineComponentProvider) {
        var _this = this;
        ...
        this.credentials.setChangeListener(function (user) {
            if (!initialized) {
                ...
                return _this.initializeComponents(offlineComponentProvider, onlineComponentProvider, user, persistenceResult).then(_this.initializationDone.resolve, _this.initializationDone.reject);
            }
            else {
     ...
     *     succeeded.
     */
    FirestoreClient.prototype.initializeComponents = function (offlineComponentProvider, onlineComponentProvider, user, persistenceResult) {
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 3:
                        ...
                        if (!canFallbackFromIndexedDbError(error_4)) {
                            throw error_4;
                        }
                        console.warn('Error enabling offline persistence. Falling back to' +
                            ' persistence disabled: ' +
                            error_4);
                        return [2 /*return*/, this.initializeComponents(new MemoryOfflineComponentProvider(), new OnlineComponentProvider(), user, persistenceResult)];
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    FirestoreClient.prototype.addSnapshotsInSyncListener = function (observer) {
        ...
        this.verifyNotTerminated();
        var wrappedObserver = new AsyncObserver(observer);
        this.asyncQueue.enqueueAndForget(function () { return tslib.__awaiter(_this, void 0, void 0, function () { return tslib.__generator(this, function (_d) {
            return [2 /*return*/, addSnapshotsInSyncListener(this.eventMgr, wrappedObserver)];
        }); }); });
        return function () {
            wrappedObserver.mute();
            _this.asyncQueue.enqueueAndForget(function () { return tslib.__awaiter(_this, void 0, void 0, function () { return tslib.__generator(this, function (_d) {
...
var UserDataWriter = /** @class */ (function () {
    function UserDataWriter(databaseId, serverTimestampBehavior, referenceFactory, bytesFactory) {
        this.databaseId = databaseId;
...
var Firestore = /** @class */ (function () {
    ...
    function Firestore(databaseIdOrApp, authProvider, _persistenceProvider) {
        var _this = this;
        if (_persistenceProvider === void 0) { _persistenceProvider = new MemoryPersistenceProvider(); }
    ...
    Firestore.prototype.enablePersistence = function (settings) {
        ...
        if (settings) {
            synchronizeTabs = !!settings.synchroniz